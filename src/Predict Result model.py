...
with open("../models/opening_result_encoder", "rb") as f:
    opp_enc = pickle.load(f)

X = np.load("../data/chess_deep_result_X_train.npy")
y = np.load("../data/chess_deep_result_y_train.npy")
#X = np.array(X)
...
model.save("../models/chess_deep_result.h5")
